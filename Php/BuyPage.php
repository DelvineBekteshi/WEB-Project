...
<head>
    ...
    <link href='../Fotot/https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
</head>
<body>
...
<main>
    ...
    <?php foreach ($houses as $house): ?>
            <div class="house">
                <img src="<?php echo '../Fotot/'.htmlspecialchars($house['image_url']); ?>" alt="House Image" id="house">
                <div>
